...
public class USBDASK
{
    ...
    public const ushort NUM_MODULE_TYPE           = 7;
...
// Gated Trigger Level
    public const ushort P1902_AI_Gate_ActiveHigh  = 0x000;
    public const ushort P1902_AI_Gate_ActiveLow      = 0x040;
...
//-------------------------------
    ...
    public const ushort CPI0_3_GPO0        = 0x02;
    ...
    public const ushort CPI4_7_GPO2        = 0x20;
    public const ushort ENC1_GPO1          = 0x40;
    public const ushort GPTC2_TC3          = 0x80;    

// GPIO Port
    public const ushort GPIO_PortA         = 1;
    public const ushort GPIO_PortB         = 2;
...
/*----------------------------------------------------------------------------*/
    ...
    [DllImport(UDDASK_DLL_FILE_NAME)]
    public static extern short UD_Device_Scan (out ushort pModuleNum, [In, Out] USBDAQ_DEVICE[] pAvailModules );
/*----------------------------------------------------------------------------*/
/* AI Function */    
    [DllImport(UDDASK_DLL_FILE_NAME)]
...
/*---------------------------------------------------------------------------*/
    ...
    [DllImport(UDDASK_DLL_FILE_NAME)]
    public static extern short UD_AO_AsyncCheck (ushort CardNumber, out bool Stopped, out uint AccessCnt);
    [DllImport(UDDASK_DLL_FILE_NAME)]
    ...
    [DllImport(UDDASK_DLL_FILE_NAME)]
    public static extern short UD_AO_AsyncDblBufferTransfer(ushort CardNumber, int wbufferId, short[] buffer);
    [DllImport(UDDASK_DLL_FILE_NAME)]
...
/*---------------------------------------------------------------------------*/
    ...
    //For USB-2401
    [DllImport(UDDASK_DLL_FILE_NAME)]
    public static extern short UD_DIO_2401_Config(ushort CardNumber, ushort wPart1Cfg);
